...
const JoinedOrganizationDetails = () => {
  ...
  const handleJoinCourse = async (courseId) => {
    ...
    try {
      ...
      setErrorMessage(err.response?.data?.message || 'Failed to join course');
    }
  };
            ...
            >
              <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                {availableCourses.length > 0 ? (
                  <CourseList courses={availableCourses} onJoinCourse={handleJoinCourse} join={true} />
                ) : (
                  ...
                  <div>
                    ...
                    {organization.vision && (
                      <div className="mt-4">
                        ...
                        <div className="bg-[#FFFCF4] p-4 rounded-lg">
                          <p className="text-[#57321A]">{organization.vision}</p>
                        </div>
                      </div>
                    )}
                  </div>
...
export default JoinedOrganizationDetails;