const GlitchText = ({
    ...
    const inlineStyles = {
      ...
      "--after-shadow": enableShadows ? "-5px 0 #57321A" : "none", // red shadow
      "--before-shadow": enableShadows ? "5px 0 #EFC815" : "none", // cyan shadow
    };
    ...
    const pseudoClasses = !enableOnHover
      ...
      : 
        ...
        "hover:after:content-[attr(data-text)] hover:after:opacity-100 hover:after:bg-[#060606] hover:after:[text-shadow:var(--after-shadow)] hover:after:animate-glitch-after " +
        "hover:before:content-[attr(data-text)] hover:before:opacity-100 hover:before:bg-[#060606] hover:before:[text-shadow:var(--before-shadow)] hover:before:animate-glitch-before";
