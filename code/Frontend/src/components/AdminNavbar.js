  ...
  return (
    <>
      ...
      <button
        ...
        className={`hidden md:flex fixed bottom-4 ${isCollapsed ? 'left-[68px]' : 'left-[268px]'} z-50 bg-cream p-2 rounded-full shadow-lg text-brown hover:text-yellow transition-all duration-300 items-center justify-center`}
      >
        ...
        <div className="p-6 border-b border-brown/20">
          <Link to="/admin/dashboard" className="flex items-center gap-2">
            ...
            <div className={`transition-all duration-300 overflow-hidden whitespace-nowrap
              ...
              <p className="text-sm text-brown/60">Admin Panel</p>
            </div>
          </Link>
        </div>
